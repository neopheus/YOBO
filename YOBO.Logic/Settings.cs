...
namespace YOBO.Logic
{
    public class AuthSettings
    {
        ...
        {
            using (var tempWebClient = new YOBOWebClient())
            {
    ...
    public class GlobalSettings
    {
        ...
        public static GlobalSettings Load(string path, bool boolSkipSave = false)
        {
            ...
            bool isGui = (AppDomain.CurrentDomain.GetAssemblies().SingleOrDefault(a => a.FullName.Contains("YOBO.GUI")) != null);
